...
test = ['lettuce', 'bacon', 'bread', 'Sausage, Egg, & Cheese Biscuit', 'Chicken Sausage w/ Sundried Tomato']

LLM4rec(system_prompt, test, client, 1)

# COMMAND ----------

# MAGIC %md
# MAGIC ### Optimizing the function for autoregressive recommendations
# MAGIC
# MAGIC Suppose you want to recommend multiple different objects by considering the sequence of the recommendations made

# COMMAND ----------

#Suppose you want to recommend 3 items in sequence
history = ['lettuce', 'bacon', 'bread', 'Sausage']
new_recs = []
for i in range(3):
...
# MAGIC %md
# MAGIC ### Now wrap this into a function
...
sequentialrec(system_prompt, items, client, 3)
